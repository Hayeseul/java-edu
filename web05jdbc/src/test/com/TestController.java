...
public class TestController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, 
		...
		if(sPath.equals("/index.do")) {
			...
			if(result==1)response.sendRedirect("index.do");
			...
			RequestDispatcher rd = 
					request.getRequestDispatcher("web/insert.jsp");
			rd.forward(request, response);
			...
			RequestDispatcher rd = 
					request.getRequestDispatcher("web/selectOne.jsp");
			rd.forward(request, response);
			...
			RequestDispatcher rd = 
					request.getRequestDispatcher("web/selectAll.jsp");
			rd.forward(request, response);
			...
			RequestDispatcher rd = 
					request.getRequestDispatcher("web/update.jsp");
			rd.forward(request, response);
